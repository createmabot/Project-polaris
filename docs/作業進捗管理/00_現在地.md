...
- Legacy numbered docs cleanup は、削除前確認 checklist と候補分類を固定し、実削除は後続 PR で判断する。
...
- legacy numbered docs cleanup の PR 2 以降で、data / API / sample 系、screen / UI / task 系、progress 系の順に削除可否を確認する。
