...
- 未取得の高優先 market event: ISM / PMI、SQ / メジャーSQ、MSCI / FTSE rebalancing。公式 source parser / curated seed を検討するが、real external page access を required check に入れず、raw HTML / raw JSON を保存しない。
