...
- CSV import report と internal backtest report の本格比較 UX を判断する。internal backtest report は取引一覧 preview まで表示済みだが、TradingView CSV 取引明細 parser / trade-level diff / export は後続判断とする。
