...
- Home 投資カレンダーは compact calendar grid 化済み。後続候補は mobile での横スクロール体験改善、day cell の詳細 popover、月移動操作、provider / event type filter であり、外部 calendar sync や notification は引き続き後続判断にする。
