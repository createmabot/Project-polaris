...
- Phase P1: market-level event provider。Alpha Vantage / FRED / FMP の無料 API 範囲を優先し、FOMC、日銀、JPX / NYSE / Nasdaq 休場日は無料 API がない場合だけ公式 source の限定 scraping または curated fixture を検討する。
