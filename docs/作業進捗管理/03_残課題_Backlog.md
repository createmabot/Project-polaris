...
- SymbolDetail related references は日本語 type badge / title / summary の読みやすい card 表示まで完了。後続候補は source reliability、dedupe、importance、filter / pagination、参照 source の品質表示であり、raw provider response や raw URL 本文表示は引き続き行わない。
