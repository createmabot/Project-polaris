...
- sanitized provider event log persistence、trend aggregation / benchmark records、provider cost / rate guard、request-time provider selection、optional fallback metadata。
