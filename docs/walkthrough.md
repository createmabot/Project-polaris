...
8. malformed JSON、schema invalid、required field missing、candidate count invalid、`source_type=web` は sanitized error として表示され、raw Codex output、endpoint、model 実値、local path、stack trace は表示・保存されないことを確認する。
