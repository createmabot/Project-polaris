...
7. artifact metadata / retention / file access boundary の詳細は `docs/運用ドキュメント/09_artifact_metadata_retention運用.md` を参照する。
8. 確認では API / backend / DB / Prisma schema / artifact 操作 / AI summary 自動生成を変更しない。
