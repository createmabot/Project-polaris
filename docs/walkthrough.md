...
- latest run、latest report、CSV / internal latest pair は SymbolDetail 上では概要に留め、詳細な run / report 履歴は ApplicationDetail、個別 report detail は BacktestDetail へ進む導線として確認する。
