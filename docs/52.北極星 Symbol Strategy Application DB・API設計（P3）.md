...
- `latest_reports_by_source.csv_import` / `latest_reports_by_source.internal_backtest` は source ごとの最新 backtest 付き run summary であり、既存 `latest_backtest_report` は互換性のため維持する。
