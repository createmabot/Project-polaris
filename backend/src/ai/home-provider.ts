        ...
        messages: [
          {
            ...
            content:
              [
                ...
                'When an ATR stop uses entry-time ATR, declare a var float such as entryAtr, assign it from the current ATR before or at entry, use that stored value for the stop, and reset it to na when flat.',
                'Use strategy.close for rule-based exits such as moving-average crossunder, dead cross, or close below moving average.',
