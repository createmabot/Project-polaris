        ...
        messages: [
          {
            ...
            content:
              [
                ...
                'When an ATR stop uses entry-time ATR, declare a var float such as entryAtr, assign it from the current ATR before or at entry, and use that stored value for the stop.',
